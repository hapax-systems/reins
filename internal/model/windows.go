...
var windowRegistry = []WindowDef{
	...
	{Key: "", ID: "identity", Name: "A1 identity", Short: "ident", Page: PageIdentity, Scope: "instance", Lifecycle: "system", Kind: "reference"},
	{Key: "B", ID: "relational", Name: "A6 relational", Short: "consent", Page: PageRelational, Scope: "instance", Lifecycle: "system", Kind: "reference"},
...
var sessionSplitDefs = []SplitPairDef{
	...
	{Page: PageIdentity, Source: "sessions", Target: "identity roster", Join: "who-is-acting", Mode: splitModeReference, SourceCursor: splitSourceAnchor, TargetReactivity: splitTargetIndependent, TargetCursor: splitTargetScroll, TargetScrollable: true, SourceOwnedVerbs: splitSessionVerbs(), Contract: "the deduped principal roster (lanes/actors/owners); self-anchored"},
	{Page: PageRelational, Source: "sessions", Target: "consent posture", Join: "who-is-affected", Mode: splitModeReference, SourceCursor: splitSourceAnchor, TargetReactivity: splitTargetIndependent, TargetCursor: splitTargetScroll, TargetScrollable: true, SourceOwnedVerbs: splitSessionVerbs(), Contract: "the access-control posture (frame/authorship/gating/stakeholders); self-anchored"},
